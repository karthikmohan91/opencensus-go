...
import (
	...
	i "github.com/influxdata/influxdb/client/v2"
	"go.opencensus.io/exporter/influxdb"
...
func main() {
	...
	exporter, err := influxdb.NewExporter(influxdb.Options{
		Database:        "test",
		RetentionPolicy: "",
		InfluxClientConfig: i.HTTPConfig{
